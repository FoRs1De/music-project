...
const Relaxation = () => {
  ...
  const token =
    "BQCirpQj8r5j4hu6KielQ3IG-Sbfb5GD4CfruDKfnqfs-n_SDYLqFvIVnptdL_B1B8cQEWtel9jnU3M-WC2iJSM2s-i9FifDIMduH3O8zDAl3aqw7ZgDtntkUzKstsYh-VdZWQ68KJ6lBAQyWSrrYyJlFpa0YYNAMsxe_dHx00jjiGp38FJmIIVez3OX6MUtu4sNpJa8vZo"; // Spotify access token
